...
<div align="center">
  <table width="960" border="0">
    ...
    <tr>
      <td colspan="3" valign="bottom"><span class="STYLE3"><img src="../guidebar_icon/smallhouse_icon.jpg" width="27" height="24" align="bottom" />当前位置：<span class="STYLE4">首页&gt;公告</span></span></td>
    </tr>
    <tr bgcolor=#CCE6FF>
	  <td width=50 class=STYLE6>序号</td><!--伪序号-->
	  <td class=STYLE6>标题</td>
	...
	if($link_id)
	{
		//mysql_select_db("bluezone");
		$result=mysql_query("SELECT `num`,`title`,`datee` FROM `bluezone`.`notice`");
